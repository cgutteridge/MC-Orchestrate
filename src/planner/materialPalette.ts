 ...
 * For vanilla-only membership, see {@link isVanillaMinecraftBlockId} in
 * `minecraftBlockRegistry.ts` (generated from `minecraft-data`).
...
export { MATERIAL_ALIASES, SUPPORTED_MATERIAL_HINTS };
